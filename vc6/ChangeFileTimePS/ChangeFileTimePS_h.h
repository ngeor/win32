...
#define __IChangeFileTimeHandler_INTERFACE_DEFINED__
	...
	IChangeFileTimeHandler : public IDispatch{public : };
	...
	typedef struct IChangeFileTimeHandlerVtbl
	{
		...
		ULONG(STDMETHODCALLTYPE *AddRef)(IChangeFileTimeHandler *This);

		ULONG(STDMETHODCALLTYPE *Release)(IChangeFileTimeHandler *This);
		...
		/* [local] */ HRESULT(STDMETHODCALLTYPE *Invoke)(IChangeFileTimeHandler *This,
		                                                 /* [annotation][in] */
...
#define IChangeFileTimeHandler_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IChangeFileTimeHandler_Release(This) ((This)->lpVtbl->Release(This))

#define IChangeFileTimeHandler_GetTypeInfoCount(This, pctinfo) ((This)->lpVtbl->GetTypeInfoCount(This, pctinfo))
...
#define IChangeFileTimeHandler_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo,     \
                                      puArgErr)                                                                        \
	...
	class DECLSPEC_UUID("6736099C-D4FA-4006-8B89-223BC5BAA967") ChangeFileTimeHandler;
#endif
